      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php
            ...
            $det=mysqli_query($conn, "select * from keluar where id='$id_brg'");
        ...
        <form   method="post" name='edit'>
          <div class="row ml-5 mb-2 mt-3">
            <div class="col-md-6">
               ...
               <P><b>Pengeluaran:</b></p>
            <input class="form-control" type="text" name='nama' placeholder="Nama Barang..."  value="<?php echo $d['nama']; ?>" required>
