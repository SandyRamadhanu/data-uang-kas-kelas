      ...
      <div id="content">
        ...
        <div class="container-fluid">
                       ...
                       <h6 class="m-0 font-weight-bold text-primary">Data Pemasukan Kas:</h6>
                               ...
                               <h7 class="m-0 font-weight-bold">Kapasitas Kas Di Tabel: <?php echo $kap; ?></h7><br>
                               <a href="export_kas.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>

                                       </div>

                                       <div class="col-md-4 mt-5 ">
                                         <form class="form-inline my-2 my-lg-0" action="cari_kas.php" method="get" name='cari'>
                                     ...
                                     if(mysqli_num_rows($brg)){
                                       ...
                                       <tbody>
                                         <tr>
                                           ...
                                           <td>&nbsp;<a href="edit_kas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-success">Edit</button></a> &nbsp; <a href="hapus_kas.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-danger">Hapus</button></a> &nbsp;</td>
